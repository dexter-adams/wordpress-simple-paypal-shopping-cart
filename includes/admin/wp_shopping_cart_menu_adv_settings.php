...
function show_wp_cart_adv_settings_page()
{
    ...
    <div class="wspsc_yellow_box">
        <p><?php _e( "For more information, updates, detailed documentation and video tutorial, please visit:", "wordpress-simple-paypal-shopping-cart" ); ?><br/>
            <a href="https://www.tipsandtricks-hq.com/wordpress-simple-paypal-shopping-cart-plugin-768"
               target="_blank"><?php _e( "WP Simple Cart Homepage", "wordpress-simple-paypal-shopping-cart" ); ?></a></p>
    </div>
            ...
            <div class="inside">
                ...
                <table class="form-table">
                    <tr valign="top">
                        ...
                        <td>
                            <select name="wpspc_pp_smart_checkout_btn_size">
								...
								echo WPSPCAdminUtils::gen_options( [
									                                   [ 'medium', __( "Medium", "wordpress-simple-paypal-shopping-cart" ) ],
									                                   [ 'large', __( "Large", "wordpress-simple-paypal-shopping-cart" ) ],
									                                   [ 'responsive', __( "Repsonsive", "wordpress-simple-paypal-shopping-cart" ) ],
								                                   ], $btn_size );
								?>
                            </select>
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            <select name="wpspc_pp_smart_checkout_btn_color">
								...
								echo WPSPCAdminUtils::gen_options( [
									                                   [ 'gold', __( "Gold", "wordpress-simple-paypal-shopping-cart" ) ],
									                                   [ 'blue', __( "Blue", "wordpress-simple-paypal-shopping-cart" ) ],
									                                   [ 'silver', __( "Silver", "wordpress-simple-paypal-shopping-cart" ) ],
									                                   [ 'black', __( "Black", "wordpress-simple-paypal-shopping-cart" ) ],
								                                   ], $btn_color );
								?>
                            </select>
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            <p><label><input type="radio" name="wpspc_pp_smart_checkout_btn_shape"
                                             value="rect"<?php WPSPCAdminUtils::e_checked( $btn_shape, 'rect', true ); ?>> <?php _e( "Rectangular ", "wordpress-simple-paypal-shopping-cart" ); ?>
                                </label></p>
                            <p><label><input type="radio" name="wpspc_pp_smart_checkout_btn_shape"
                                             value="pill"<?php WPSPCAdminUtils::e_checked( $btn_shape, 'pill' ); ?>> <?php _e( "Pill", "wordpress-simple-paypal-shopping-cart" ); ?></label></p>
                    ...
                    <tr valign="top">
                        ...
                        <td>
                            <p><label><input type="radio" name="wpspc_pp_smart_checkout_btn_layout"
                                             value="vertical"<?php WPSPCAdminUtils::e_checked( $btn_layout, 'vertical', true ); ?>> <?php _e( "Vertical", "wordpress-simple-paypal-shopping-cart" ); ?>
                                </label></p>
                            <p><label><input type="radio" name="wpspc_pp_smart_checkout_btn_layout"
                                             value="horizontal"<?php WPSPCAdminUtils::e_checked( $btn_layout, 'horizontal' ); ?>> <?php _e( "Horizontal", "wordpress-simple-paypal-shopping-cart" ); ?>
                                </label></p>
                ...
                <table class="form-table">
                    <tr valign="top">
                        ...
                        <td>
                            <p><label><input type="checkbox" name="wpspc_pp_smart_checkout_payment_method_credit"
                                             value="1"<?php WPSPCAdminUtils::e_checked( $pm_credit ); ?>> <?php _e( "PayPal Credit", "wordpress-simple-paypal-shopping-cart" ); ?></label></p>
                            <p><label><input type="checkbox" name="wpspc_pp_smart_checkout_payment_method_elv"
                                             value="1"<?php WPSPCAdminUtils::e_checked( $pm_elv ); ?>> <?php _e( "ELV", "wordpress-simple-paypal-shopping-cart" ); ?></label></p>
